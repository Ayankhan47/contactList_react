...
const App = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    setallUsers([...allUsers, { name, company, phone, Favroite }]);
  ...
  return (
    <div className="h-screen bg-gray-50 p-6 flex font-[helvetica]" id="main">
      <div id="left" className="h-[90vh] w-[50vw] p-6 bg-white rounded-xl">
        <h1 className="font-[gilroy] text-3xl font-semibold mb-[2vw]">
          Add Contact
        </h1>
        <form
          onSubmit={(e) => {
        ...
        >
          ...
          />
          <label className="text-lg">
            Company <sup className="text-red-500 text-md">*</sup>
          </label>
          <input
            onChange={(elem) => {
          ...
          />
          <label className="text-lg">
            Phone <sup className="text-red-500 text-md">*</sup>
          </label>
          <input
            onChange={(elem) => {
          ...
          <div id="checkbox" className="felx text-lg">
            <input
              checked={Favroite}
              onChange={(e) => {
                setFavroite(e.target.checked);
              }}
              className="h-[2.6vh] w-[2.6vw]"
              type="checkbox"
            />
      ...
      <div
        id="right"
        className="p-[3vw] h-[90vh] w-[50vw] overflow-y-auto scrollbar-hide"
      >
          ...
          return (
            ...
            >
              <button
                ...
                className="text-white bg-red-500 text-xs py-1 px-2 rounded-lg absolute top-2 right-3 opacity-0 group-hover:opacity-100 transition-opacity"
              >
                Delete
              </button>
              ...
              {elem.Favroite ? (
                <div
                  className=" mt-4 py-1 px-4 bg-yellow-500 text-white rounded-lg w-fit"
                  id="favroite"
                >
                  <h4>Favroite</h4>
                </div>
